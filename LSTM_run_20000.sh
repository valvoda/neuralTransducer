    ...
    do
      ...
      do
        ...
        bsub -W $TIME \
             ...
             python src/train.py --dataset scan --train Experiments_20000/${train_dir}/${experiment}/tasks_train_simple.txt --dev Experiments_20000/${train_dir}/${experiment}/tasks_train_simple.txt --test Experiments_20000/${train_dir}/${experiment}/tasks_test_simple.txt  --model LSTM_200/${size}/${experiment} --embed_dim 100 \
             --src_hs ${size} \
             --trg_hs ${size} \
             --dropout 0.5 \
             --src_layer 2 \
